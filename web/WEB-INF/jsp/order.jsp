...
<div class="container cart">
    ...
    <div class="span24">
        ...
        <table>
            <tbody>
            <tr>
                <th colspan="5">定单编号：<s:property value="model.oid"/>&nbsp;&nbsp;&nbsp;&nbsp;</th>
                </tr>
            <tr>
                <th>图片</th>
                <th>商品</th>
            ...
            <s:iterator value="model.orderItems" var="m">
            <tr>
                <td width="60">
                    <input type="hidden" name="id" value="22"/>
                    <img src="${pageContext.request.contextPath}/<s:property value="#m.product.image"/>"/>
                </td>
                <td>
                    <a target="_blank"><s:property value="#m.product.pname"/></a>
                </td>
                <td>
                    <s:property value="#m.product.shop_price"/>
                </td>
                <td class="quantity" width="60">
                    <s:property value="#m.count"/>
                </td>
                <td width="140">
                    <span class="subtotal">  <s:property value="#m.subtotal"/></span>
                </td>
